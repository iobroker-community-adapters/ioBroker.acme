"use strict";var ct=Object.defineProperty,ht=Object.defineProperties;var mt=Object.getOwnPropertyDescriptors;var G=Object.getOwnPropertySymbols;var ye=Object.prototype.hasOwnProperty,Ee=Object.prototype.propertyIsEnumerable;var te=(d,s,t)=>s in d?ct(d,s,{enumerable:!0,configurable:!0,writable:!0,value:t}):d[s]=t,oe=(d,s)=>{for(var t in s||(s={}))ye.call(s,t)&&te(d,t,s[t]);if(G)for(var t of G(s))Ee.call(s,t)&&te(d,t,s[t]);return d},Te=(d,s)=>ht(d,mt(s));var we=(d,s)=>{var t={};for(var l in d)ye.call(d,l)&&s.indexOf(l)<0&&(t[l]=d[l]);if(d!=null&&G)for(var l of G(d))s.indexOf(l)<0&&Ee.call(d,l)&&(t[l]=d[l]);return t};var f=(d,s,t)=>te(d,typeof s!="symbol"?s+"":s,t);var Q=(d,s,t)=>new Promise((l,i)=>{var I=T=>{try{N(t.next(T))}catch(g){i(g)}},P=T=>{try{N(t.throw(T))}catch(g){i(g)}},N=T=>T.done?l(T.value):Promise.resolve(T.value).then(I,P);N((t=t.apply(d,s)).next())});(self.webpackChunkiobroker_admin_component_acme=self.webpackChunkiobroker_admin_component_acme||[]).push([["vendors-node_modules_emotion_react_dist_emotion-element-f0de968e_browser_esm_js-node_modules_-9eaa15"],{17739:((d,s,t)=>{t.r(s),t.d(s,{AdminConnection:()=>lt.w,ColorPicker:()=>m.s,ComplexCron:()=>c.J,ComplexCronDialog:()=>ae.j,Confirm:()=>V.Z,Connection:()=>Y.Ng,Cron:()=>re.j,CustomModal:()=>u.j,DeviceTypeIcon:()=>Se.I,DeviceTypeSelector:()=>Ie.o,DialogComplexCron:()=>ae.j,DialogConfirm:()=>V.Z,DialogCron:()=>re.j,DialogError:()=>k.J,DialogMessage:()=>ie.A,DialogSelectFile:()=>le.J,DialogSelectID:()=>se._,DialogSimpleCron:()=>de.T,DialogTextInput:()=>ce.k,ERRORS:()=>Y.Sr,EXTENSIONS:()=>F.Z1,Error:()=>k.J,FileBrowser:()=>y.V,FileBrowserClass:()=>y.F,FileViewer:()=>F.hc,FileViewerClass:()=>F.ng,GenericApp:()=>D,I18n:()=>w.F,ITEM_IMAGES:()=>X.fb,Icon:()=>O.In,IconAdapter:()=>Ke.r,IconAlias:()=>He._,IconButtonImage:()=>Xe.f,IconChannel:()=>Ye.f,IconClearFilter:()=>Ze.R,IconClosed:()=>Ge.A,IconCopy:()=>Qe.b,IconDevice:()=>je.W,IconDocument:()=>qe.F,IconDocumentReadOnly:()=>_e.D,IconExpert:()=>et.E,IconFx:()=>tt.Y,IconInstance:()=>ot.L,IconLogout:()=>nt.E,IconNoIcon:()=>at.C,IconOpen:()=>rt.Y,IconPicker:()=>H.a,IconSelector:()=>U.N,IconState:()=>it.n,IconVacuum:()=>st.l,Image:()=>L._,InfoBox:()=>De.w,LegacyConnection:()=>he.ck,Loader:()=>R,LoaderMV:()=>Ve.h,LoaderPT:()=>Je.C,LoaderVendor:()=>$e.k,Logo:()=>be.g,MDUtils:()=>Ne.x,Message:()=>ie.A,ObjectBrowser:()=>X.Sn,ObjectBrowserClass:()=>X.iJ,PERMISSION_ERROR:()=>Y.fq,PROGRESS:()=>Y.Gd,Router:()=>x.I,STATES_NAME_ICONS:()=>pe.K,SaveCloseButtons:()=>j.N,Schedule:()=>Oe.q,SelectFile:()=>le.J,SelectID:()=>se._,SelectWithIcon:()=>Pe.y,SimpleCron:()=>ne.N,SimpleCronDialog:()=>de.T,TabContainer:()=>Me.j,TabContent:()=>Re.J,TabHeader:()=>Ae.t,TableResize:()=>Fe.R,TextInput:()=>ce.k,TextWithIcon:()=>ke.d,Theme:()=>l.S,ToggleThemeMenu:()=>Le.l,TreeTable:()=>Be.z,UploadImage:()=>Ue.t,Utils:()=>A.A,convertCronToText:()=>ze.U,copy:()=>h.C,cron2state:()=>ne.c,dictionary:()=>K.z,extendDeviceTypeTranslation:()=>xe.K,getAttrInObject:()=>$.c7,getSelectIdIcon:()=>O.lh,getSelectIdIconFromObjects:()=>X.XV,getSystemIcon:()=>O.dz,iobUriParse:()=>$.u_,iobUriRead:()=>$.BC,iobUriToString:()=>$.BW,moduleFederationShared:()=>dt.l,pattern2RegEx:()=>he.Sy,printPrompt:()=>v.E,setAttrInObject:()=>$.AL,withWidth:()=>We.x});var l=t(78838),i=t(77810),I=t(89855),P=t(16015),N=t(51383),T=t(35723),g=t(186),z=t(20500),M=t(1103),v=t(8193);const S=`
/**
...
`;function R(b){(0,i.useEffect)(()=>{if(!window.document.getElementById("loader-iobroker-component")){const o=window.document.createElement("style");o.setAttribute("id","loader-iobroker-component"),o.innerHTML=S,window.document.head.appendChild(o)}},[]);const W=b.size||234,e=b.themeName||b.theme||b.themeType||"light";return i.createElement("div",{className:`logo-back logo-background-${e}`,style:{backgroundImage:b.backgroundImage&&b.backgroundImage!=="@@loginBackgroundImage@@"?b.backgroundImage:window.loadingBackgroundImage&&window.loadingBackgroundImage!=="@@loginBackgroundImage@@"?`url(${window.loadingBackgroundImage})`:void 0,backgroundColor:b.backgroundColor&&b.backgroundColor!=="@@loginBackgroundColor@@"?b.backgroundColor:window.loadingBackgroundColor&&window.loadingBackgroundColor!=="@@loginBackgroundColor@@"?window.loadingBackgroundColor:void 0,backgroundSize:"cover"}},window.loadingHideLogo==="true"?null:i.createElement(i.Fragment,null,i.createElement("div",{className:"logo-div",style:{width:W,height:W}},i.createElement("div",{className:`logo-top logo-background-${e}`,style:{left:"37%"}}),i.createElement("div",{className:`logo-top logo-background-${e}`,style:{left:"57%"}}),i.createElement("div",{className:`logo-border logo-background-${e} logo-animate-wait`,style:{borderWidth:W*.132}}),i.createElement("div",{className:`logo-i logo-animate-color-inside-${e}`}),i.createElement("div",{className:`logo-i-top logo-animate-color-inside-${e}`,style:{top:"18%"}}),i.createElement("div",{className:`logo-i-top logo-animate-color-inside-${e}`,style:{bottom:"18%"}})),i.createElement("div",{className:`logo-animate-grow logo-animate-grow-${e}`,style:{width:W+11,height:W+11}})))}var x=t(33967),A=t(1821),j=t(55102),V=t(45189),w=t(20363),k=t(55043),K=t(46023);const q=`
html {
    height: 100%;
}
